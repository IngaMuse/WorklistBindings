sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/WorklistBindings/app", ".html");
		...
		return Opa5.extend("zjblessons.WorklistBindings.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/WorklistBindings/localService/mockserver"], function (mockserver) {
